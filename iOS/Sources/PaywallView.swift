        ...
        NavigationStack {
            ZStack {
                ...
                VStack(spacing: 24) {
                    ...
                    Text("Barnyard Log Pro")
                        .font(Theme.titleFont)
                        .foregroundStyle(Theme.textPrimary)
                    Text("Egg-count trend chart and multi-animal profiles")
                        .font(Theme.bodyFont)
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        Label("Egg-count trend chart and multi-animal profiles", systemImage: "chart.line.uptrend.xyaxis")
                    }
                    .font(Theme.bodyFont)
                    .foregroundStyle(Theme.textPrimary)
                    .padding()
